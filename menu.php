...
<div class="navigation">
    <div class="secondary-navigation">
        <div class="container">
            <!--
            <div class="contact">
                <figure><strong>Telefone:</strong>+1 810-991-3842</figure>
                <figure><strong>Email:</strong>contato@queroumacelula.com.br</figure>
            </div>
            -->
            <div class="user-area">                
                <a href="create-account.html" class="promoted"><strong>Criar Nova Conta</strong></a>
                <a href="sign-in.html">Entrar</a>
            </div>
        </div>
    </div>
    <div class="container">
        <header class="navbar" id="top" role="banner">
            <div class="navbar-header">
                ...
                <div class="navbar-brand nav" id="brand">
                    <a href="index-google-map-fullscreen.html">
                        <span style="font-size:2em; font-family: 'Lobster', cursive;">Quero uma c&eacute;lula</span>
                        <!--
            ...
            <div class="add-your-property">
                <a href="submit.html" class="btn btn-default"><i class="fa fa-plus"></i><span class="text">Adicionar uma C&eacute;lula</span></a>
            </div>
        </header><!-- /.navbar -->
    </div><!-- /.container -->
</div><!-- /.navigation -->
